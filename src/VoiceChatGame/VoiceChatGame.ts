...
export type gameValues = "youtube" | "poker" | "betrayal" | "fishing" | "chess" | "lettertile" | "wordsnack" | "doodlecrew" | "awkword" | "spellcast" | "checkers" | "puttparty" 
            ...
            try {
                ...
                .then((res) => {
                    ...
                    if(res.code as Number === 50013) throw new DiscordGamesError(`Looks like you do not have the permission to do this action`);
                        ...
                        resultData.invite = `https://discord.gg/${res.code}`,
